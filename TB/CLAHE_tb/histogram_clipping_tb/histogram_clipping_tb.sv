...
module histogram_clipping_tb();
    ...
    initial begin
        ...
        wait(clip_ready == 1'b1);
        $display("Clipping complete!");
    ...
    task collect_output;
        begin
            $display("Opening hardware_histogram_clipped.txt for writing...");
            file_id = $fopen("hardware_histogram_clipped.txt", "w"); 
